...
render(siteMainElement, createTripTemplate(), `afterbegin`);
...
render(siteControlElement, createFilterTemplate(), `afterbegin`);

const createSwitchTemplate = () => {
...
render(siteControlElement, createSwitchTemplate(), `afterbegin`);
...
render(siteEventElement, createEventTemplate(), `afterbegin`);
